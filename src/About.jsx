...
function About() {
    return (
        <section className="text-gray-700 flex items-center h-[517px] md:h-auto body-font bg-slate-100 my-0 md:my-24  px-32">
            <div className="container mx-auto flex flex-col md:flex-row px-5 items-center">
                ...
                <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <div className="flex justify-center">
                        <button class="font-primary inline-block px-5 py-2 mt-2 md:mt-0 mx-auto text-white bg-orange rounded-full hover:bg-orange md:mx-0">
                            Explore Now
                        </button>
                    </div>
                </div>
